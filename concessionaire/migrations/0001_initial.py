# Generated by Django 4.1.4 on 2023-02-17 18:24
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title_status', models.CharField(choices=[('Clean', 'Clean'), ('Rebuilt/Reconstructed', 'Rebuilt/Reconstructed')], default='Clean', max_length=50)),
                ('traction', models.CharField(choices=[('FourWD', 'FourWD'), ('AWD', 'AWD'), ('FWD', 'FWD'), ('RWD', 'RWD')], default='FourWD', max_length=50)),
